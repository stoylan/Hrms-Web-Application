...
public class ANQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ANQDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ANQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ANQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ANQDateTimeConverter dateTimeConverter = new ANQStandardDateTimeConverter();

    public ANQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ANQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ANQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ANQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ANQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ANQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
