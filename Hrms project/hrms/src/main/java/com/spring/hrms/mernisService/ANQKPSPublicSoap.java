...
public class ANQKPSPublicSoap
{
    ...
    public ANQKPSPublicSoap(){}

    public ANQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ANQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ANQExtendedSoapSerializationEnvelope envelope= new ANQExtendedSoapSerializationEnvelope(ANQExtendedSoapSerializationEnvelope.VER11);
