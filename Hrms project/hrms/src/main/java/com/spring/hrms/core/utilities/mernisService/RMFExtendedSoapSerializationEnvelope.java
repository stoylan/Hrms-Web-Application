...
public class RMFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RMFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RMFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RMFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RMFDateTimeConverter dateTimeConverter = new RMFStandardDateTimeConverter();

    public RMFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RMFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RMFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RMFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RMFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RMFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
