...
public class DIWKPSPublicSoap
{
    ...
    public DIWKPSPublicSoap(){}

    public DIWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DIWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DIWExtendedSoapSerializationEnvelope envelope= new DIWExtendedSoapSerializationEnvelope(DIWExtendedSoapSerializationEnvelope.VER11);
