...
public class DIWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DIWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DIWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DIWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DIWDateTimeConverter dateTimeConverter = new DIWStandardDateTimeConverter();

    public DIWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DIWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DIWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DIWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DIWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DIWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
